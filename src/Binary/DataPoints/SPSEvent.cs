...
{
    public class SPSEvent : ProcessDataPointValue
    {
        ...
        ///     member "NodeID".
        /// </summary>
        public static NodeID PreDefinedNodeID = new NodeID( 1, 6 );

        public SPSEvent() : base( "ValueQc", "originalTimestamp" )
        {
            Value = false;
        }
        ...
        public static StructureDescription SPSEventStructureDescription
        {
            get
            {
                StructureDescription desc = new StructureDescription( "SPSEvent",
                                                                      PreDefinedNodeID,
